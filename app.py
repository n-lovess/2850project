...
translations = {
    ...
    "fr": {
        ...
        "payments": "Paiements",
        "payments_text": "Tous les paiements doivent être effectués intégralement avant qu’une réservation soit confirmée.",
        "changes_cancellations": "Modifications et annulations",
        "changes_cancellations_text": "Les modifications et annulations dépendent du type de tarif et de la politique de la compagnie.",
        "passenger_responsibility": "Responsabilité du passager",
        "passenger_responsibility_text": "Les passagers sont responsables de s’assurer qu’ils disposent de documents de voyage valides.",
        "special_requests": "Demandes spéciales",
        "special_requests_text": "Les demandes seront enregistrées mais restent soumises à disponibilité.",
        "notifications_offers": "Notifications et offres",
        "notifications_offers_text": "Si vous acceptez, AirGo peut vous envoyer des offres et mises à jour par email.",
    },
    ...
    "ar": {
        ...
        "booking_terms_text": "بإتمام الحجز، تؤكد صحة جميع البيانات.",
        "payments": "المدفوعات",
        "payments_text": "يجب إتمام الدفع بالكامل قبل تأكيد الحجز.",
        "changes_cancellations": "التغييرات والإلغاءات",
        "changes_cancellations_text": "تخضع لسياسة شركة الطيران.",
        "passenger_responsibility": "مسؤولية المسافر",
        "passenger_responsibility_text": "يجب التأكد من صلاحية وثائق السفر.",
        "special_requests": "الطلبات الخاصة",
        "special_requests_text": "تخضع لتوفر الخدمة.",
        "notifications_offers": "الإشعارات والعروض",
        "notifications_offers_text": "قد يتم التواصل معك عبر البريد الإلكتروني.",
    }
}
def get_translation():
